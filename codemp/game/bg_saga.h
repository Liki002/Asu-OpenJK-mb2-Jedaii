...
#define MAX_EXDATA_ENTS_TO_SEND                                                \
  MAX_CLIENTS // max number of extended data for ents to send
...
// for ui
int BG_GetUIPortrait(const int team, const short classIndex,
                     const short cntIndex);
char *BG_GetUIPortraitFile(const int team, const short classIndex,
                           const short cntIndex);
