...
static const shopItem_t sv_shopItems[] = {
    ...
    {"wp_pistol", "^3Bryar Pistol ^7(MBII Pistol with ammo)", 1500, 500},
    {"wp_blaster", "^2E11 Blaster Rifle ^7(MBII E11 Rifle)", 3000, 1000},
    {"wp_disruptor", "^1Disruptor Rifle ^7(Sniper rifle with zoom)", 5000, 1500},
    {"wp_bowcaster", "^2Wookiee Bowcaster ^7(Heavy plasma blaster)", 3500, 1200},
    {"wp_repeater", "^3Heavy Repeater ^7(Rapid-fire repeater)", 4000, 1300},
    {"wp_demp2", "^5DEMP2 Gun ^7(Ion shock gun)", 2500, 800},
    {"wp_flechette", "^6Golan Arms Flechette ^7(Spread shotgun/mines)", 4500, 1500},
    {"wp_rocket", "^1Rocket Launcher ^7(Heavy explosive rocket)", 7500, 2500},
    {"wp_concussion", "^4Concussion Grenade ^7(3x explosive grenades)", 1200, 400},
    {"wp_thermal", "^1Thermal Detonator ^7(3x thermal detonators)", 1500, 500},
    {"wp_sentry", "^5Sentry Gun ^7(Deployable automated turret)", 2500, 800},
